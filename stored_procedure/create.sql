...
CREATE TABLE IF NOT EXISTS `infood`.`comments` (
  ...
  `date_comment` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `infood`.`Notes` (
  ...
  `date_note` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `user_id_user` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Notes_aliment1_idx` (`aliment_id_aliment` ASC),
  INDEX `fk_Notes_user1_idx` (`user_id_user` ASC),
  UNIQUE INDEX `date_note_UNIQUE` (`date_note` ASC),
