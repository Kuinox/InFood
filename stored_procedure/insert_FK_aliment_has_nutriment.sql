...
BEGIN
    SELECT aliment_id_aliment, nutriment_id_nutriment, nutriment_quantity INTO result1,result2,qty FROM aliment_has_nutriment WHERE id1 = result1 AND id2 = result2;
