...
CREATE TABLE IF NOT EXISTS `infood`.`packaging` (
  ...
  `name_packaging` VARCHAR(50) NULL,
...
CREATE TABLE IF NOT EXISTS `infood`.`ingredient` (
  ...
  `tag_ingredient` VARCHAR(45) NULL,
  PRIMARY KEY (`id_ingredient`),
  UNIQUE INDEX `idingredient_UNIQUE` (`id_ingredient` ASC))
ENGINE = InnoDB;
