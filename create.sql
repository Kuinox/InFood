...
CREATE TABLE IF NOT EXISTS `infood`.`nutriment` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_nutriment_unique` (`label` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `infood`.`generic_name` (
  ...
  `name_generic_name` MEDIUMTEXT NULL,
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment` (
  ...
  `name_aliment` MEDIUMTEXT NULL,
  `last_modification_aliment` DATETIME NULL,
  `ingredients_aliment` MEDIUMTEXT NULL,
  `generic_name_id` INT NULL,
  `grade_nutriment_id_grade_nutriment` INT NULL,
