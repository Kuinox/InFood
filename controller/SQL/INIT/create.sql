...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_label` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `label_id_nom` VARCHAR(500) NOT NULL,
  INDEX `fk_aliment_has_label_label1_idx` (`label_id_nom` ASC),
  ...
  CONSTRAINT `fk_aliment_has_label_label1`
    FOREIGN KEY (`label_id_nom`)
    REFERENCES `infood`.`label` (`id_nom`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
