...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_additives` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `additives_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_aliment_has_additives_additives1_idx` (`additives_id` ASC),
  ...
  CONSTRAINT `fk_aliment_has_additives_additives1`
    ...
    REFERENCES `infood`.`additives` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_allergens` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `allergens_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  INDEX `fk_aliment_has_allergens_allergens1_idx` (`allergens_id` ASC),
  ...
  CONSTRAINT `fk_aliment_has_allergens_allergens1`
    ...
    REFERENCES `infood`.`allergens` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_brands` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `brands_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  INDEX `fk_aliment_has_brands_brands1_idx` (`brands_id` ASC),
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_categories` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `categories_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_aliment_has_categories_categories1_idx` (`categories_id` ASC),
  ...
  CONSTRAINT `fk_aliment_has_categories_categories1`
    ...
    REFERENCES `infood`.`categories` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_ingredients` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `ingredients_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_aliment_has_ingredients_ingredients1_idx` (`ingredients_id` ASC),
  ...
  CONSTRAINT `fk_aliment_has_ingredients_ingredients1`
    ...
    REFERENCES `infood`.`ingredients` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_labels` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `labels_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_aliment_has_label_label1_idx` (`labels_id` ASC),
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_packaging` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `packaging_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_aliment_has_packaging_packaging1_idx` (`packaging_id` ASC),
...
CREATE TABLE IF NOT EXISTS `infood`.`aliment_has_traces` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aliment_id_aliment` VARCHAR(41) NOT NULL,
  `traces_id` VARCHAR(300) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_bin' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_aliment_has_traces_traces1_idx` (`traces_id` ASC),
